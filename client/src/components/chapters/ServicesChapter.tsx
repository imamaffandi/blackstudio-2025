...
const services = [
  { 
    ...
    hoverGradient: "hover:bg-gradient-to-br hover:from-pink-900/30 hover:to-pink-800/20",
    cardColor: "bg-slate-800/50"
  },
  { 
    name: "Videography", 
    icon: Video, 
    description: "Creating compelling visual stories that move and inspire",
    iconGradient: "bg-gradient-to-br from-blue-500 to-purple-600",
    hoverGradient: "hover:bg-gradient-to-br hover:from-blue-900/30 hover:to-purple-800/20",
    cardColor: "bg-slate-800/50"
  },
  { 
    name: "Graphic Design", 
    ...
    hoverGradient: "hover:bg-gradient-to-br hover:from-cyan-900/30 hover:to-cyan-800/20",
    cardColor: "bg-slate-800/50"
  },
  { 
    name: "Motion Graphics", 
    icon: Zap, 
    description: "Bringing designs to life with dynamic animations",
    iconGradient: "bg-gradient-to-br from-orange-400 to-red-500",
    hoverGradient: "hover:bg-gradient-to-br hover:from-orange-900/30 hover:to-red-900/20",
    cardColor: "bg-slate-800/50"
  },
];
      ...
      <div className="max-w-7xl mobile-container px-4 s25:px-6 md:px-8 w-full pt-12 s25:pt-16 md:pt-20 short-screen-container short-screen-center">
        <div className="text-center mb-12 short-screen-header">
          <motion.h2 
            ...
            viewport={{ once: false }}
          >
            <span className="block text-white">OUR CREATIVE ARSENAL IS UNLIKE</span>
          ...
          {services.map((service, index) => (
            ...
            >
              <div className="mb-2 md:mb-6 flex justify-center">
                <div className={`w-10 h-10 md:w-16 md:h-16 ${service.iconGradient} rounded-lg md:rounded-xl flex items-center justify-center`}>
                  <service.icon className="w-5 h-5 md:w-8 md:h-8 text-white" />
                </div>
              </div>
              <h3 className="text-sm md:text-xl font-bold mb-1 md:mb-3 text-white leading-tight">{service.name}</h3>
